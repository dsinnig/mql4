...
static ErrorType ErrorManager::submitNewOrder(int orderType, double _entryPrice, double _stopLoss, double _takeProfit, double _cancelPrice, double _positionSize, Trade* trade) {
   int maxSlippage = 4;
   int magicNumber = 0;
...
static ErrorType ErrorManager::analzeAndProcessResult() {
